...
currentReportName="";
	...
	function generateReport(reportName) {
		...
		var reporturl ="/MEDCBirtReportGenApp/loadReport?ReportName="+reportName+"&ReportFormat=html";
		
		$("#reportData").html("Loading...<br><img src='/MEDCBirtReportGenApp/images/loading.gif' align='middle' >");
	...
	function downloadReport(format){
		...
		//here relative url is given if relative url is not working try giving full url
		var reporturl ="/MEDCBirtReportGenApp/loadReport?ReportName="+currentReportName+"&ReportFormat="+format;
